...
class QuoteTest < ActiveSupport::TestCase
  ...
  test "should get report currency exchange rate" do
    assert_equal 1, quotes(:quotes_001).report_currency_exchange_rate.to_f

    assert_equal 1.561933799, quotes(:quotes_002).report_currency_exchange_rate.to_f
  end
  ...
  test "should get the updated time for the exchange rate in use" do
    assert_equal DateTime.parse('2013-02-12 11:37:32').utc, quotes(:quotes_002).get_exchange_rate_updated_at
